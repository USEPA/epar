...
Files stored on GitHub do not meet the requirements for records, therefore we need to find alternative means to make sure our GitHub based work are captured in a records friendly way.
